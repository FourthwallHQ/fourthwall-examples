  ...
  async function handleFile(file: File | undefined) {
    ...
    patch({
      artwork: {
        ...
        // Kept so publish can re-upload the raw bytes into the target shop —
        // the channel-api imageId above is preview-only (it binds to the
        // channel's own shop, not the one publish creates).
        file,
      },
    });
  }
